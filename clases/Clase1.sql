...
INTEGER(m)
Signed values range from -2147483648 to 2147483647. Unsigned values range from 0 to 4294967295.
Standard integer value. This is a synonym for the INT datatype.
...
Unpacked fixed-point number. Where m is the total digits and d is the number of digits after the decimal. (Introduced in MySQL 4.1). This is a synonym for the DECIMAL datatype.
...
Floating point number. Where p is the precision.


BOOL

Treated as a boolean data type where a value of 0 is considered to be FALSE and any other value is considered to be TRUE. Synonym for TINYINT(1)


BOOLEAN

This is a synonym for the BOOL datatype.
...
Where size is the number of characters to store (size is optional and was introduced in MySQL 4.1)
